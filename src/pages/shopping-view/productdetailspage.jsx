...
//           variant="outline"
//           size="sm"
//           className="mt-2 border-2 border-black bg-transparent shadow-md hover:bg-black hover:text-white"
...
//           className=" gap-1 w-full pl-20 pr-20 border-2 border-gray-800"
//         >
//           {cartLoading ? (
...
//           Add to Cart
//           {/* {cartQuantity > 0 && (
//             <span className="ml-1 bg-primary text-black text-xs rounded-full w-5 h-5 flex items-center justify-center">
//               {cartQuantity}
//             </span>
//           )} */}
//         </Button>
...
//         <div className="relative top-0 left-0 w-full md:w-1/2 h-auto md:h-auto flex flex-col items-center justify-center bg-background">
//           <motion.div
...
//           >
//             <img
//               // src={images[currentImage] || "https://via.placeholder.com/300"}
...
//               <button
//                 onClick={prevImage}
//                 className="absolute border-black border left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-background/80 flex items-center justify-center backdrop-blur-sm hover:bg-primary hover:text-white transition-all duration-300"
...
//               <button
//                 onClick={nextImage}
//                 className="absolute border-black border right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-background/80 flex items-center justify-center backdrop-blur-sm hover:bg-primary hover:text-white transition-all duration-300"
...
//           <div className="sticky top-0 pt-8 pb-6 bg-background z-10">
//             <h1 className="text-3xl lg:text-3xl font-bold tracking-tight text-gray-800 dark:text-white">
//               {product.title}
//             </h1>
...
//               <div className="relative bg-transparent border-2 shadow-2xl border-white p-6 rounded-lg max-w-4xl w-full">
//                 <button
//                   onClick={() => setIsZoomed(false)}
//                   className="absolute top-4 right-4 p-2 rounded-full bg-background/80 hover:bg-background/50 transition-all duration-300"
...
//                     <button
//                       onClick={prevImage}
//                       className="absolute border-black border left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-background/80 flex items-center justify-center backdrop-blur-sm hover:bg-black hover:text-white transition-all duration-300"
//                       aria-label="Previous image"
//                     >
//                       <ChevronLeft className="h-6 w-6" />
//                     </button>
//                     <button
//                       onClick={nextImage}
//                       className="absolute border-black border right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-background/80 flex items-center justify-center backdrop-blur-sm hover:bg-black hover:text-white transition-all duration-300"
//                       aria-label="Next image"
//                     >
//                       <ChevronRight className="h-6 w-6" />
//                     </button>
...
//             <Button
//               size="lg"
//               className="flex-1 gap-1 md:pr-20 md:pl-20 p-4 border-2 border-gray-800"
...
//               variant="outline"
//               className="flex items-center justify-center md:hover:bg-transparent md:gap-0 gap-2 md:p-0 p-4 md:m-0 m-0 md:border-none border-2 border-gray-800 md:rounded-full"
...
//   size="icon"
//   variant="outline"
//   className="w-8 h-8 rounded-full flex items-center justify-center border-2 border-gray-800"
//   onClick={handleToggleWishlist}
//   disabled={togglingWishlist || cartLoading}
// > */}
//               {togglingWishlist ? (
...
//                 //   color={`${isInWishlist?"black":"red"}`}
//                 //   strokeWidth={1}
//                 // />
//                 // <div className="group">
//   <Heart
//     className={`md:h-8 md:w-8 h-5 w-5 transition-colors duration-200 
//       ${isInWishlist ? "fill-red-500 hover:fill-red-300" : "fill-none hover:fill-red-500"}`}
//     color={isInWishlist ? "black" : "red"}
//     strokeWidth={1}
//   />
// // </div>
...
//             <TabsList className="w-full justify-start bg-background h-auto rounded-sm p-0 mb-2">
...
//               <motion.div
//                 className="p-6 bg-[#f2ede6df] rounded-sm shadow-md"
...
//                       </p>
//                       <p className="text-gray-700">{toTitleCase(spec.value)}</p>
//                     </div>
//                   ))
//                 ) : (
...
//                 transition={{ duration: 0.3, ease: "easeOut" }}
//               >
//                 <p>{product.shipping_info || "Standard shipping applies."}</p>
//                 <p>{product.return_policy || "30-day return policy."}</p>
//               </motion.div>
//             </TabsContent>
...
//                           className="border border-gray-300 p-4 rounded-md shadow-xl bg-white"
//                         >
...
//                               })
//                             }
//                             className="mb-3 border-gray-400 focus:border-primary"
//                           />
//                           <div className="mb-3">
//                             <Label className="font-medium text-gray-700 SOLID_BRIGHT">
//                               Upload Image:
//                             </Label>
//                             <input
//                               type="file"
...
//                         </form>
//                       ) : (
//                         <div className="border border-gray-300 p-4 rounded-md shadow-xl bg-white flex justify-between items-start">
//                           <div>
//                             <p className="font-semibold text-gray-800">
...
//                             className="ml-4 border-primary text-black hover:bg-primary hover:text-white transition-colors"
//                           >
//                             Edit
//                           </Button>
//                         </div>
...
//                       className="mb-6 border p-4 rounded-md bg-white shadow-sm"
//                     >
//                       <div className="flex items-center gap-2 mb-2">
...
//                       <div
//                         key={review.id}
//                         className="p-4 rounded-md bg-white/30 shadow-sm"
//                       >
//                         <p className="font-semibold text-gray-800">
